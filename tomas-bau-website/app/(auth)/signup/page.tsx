...
export default function SignupPage() {
  ...
  async function handleSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    // ponytail: auto-login after signup
  ...
  return (
    <div className="w-full max-w-md space-y-6">
      <div className="text-center">
        <h1 className="text-2xl font-bold text-brand-navy">Konto erstellen</h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full rounded-lg bg-brand-navy px-4 py-2.5 text-sm font-semibold text-white hover:bg-brand-navyLight disabled:opacity-50"
        >
